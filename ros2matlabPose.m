function matlab_pose = ros2matlabPose(p,frameAdjustment,toolAdjustmentFlag)
% ros2matlabPose - Converts ros pose to matlab pose according to type. 
% Extracts position into p and orientation into a quaternion via the RVC 
% Toolbox to instantiate UnitQuaternion and build a homogeneous
% transform by composing orientation and translation.
% 
% Handles two pose types:
%
...
%   and z=-z.
%
%   - toolAdjustmentFlag:flag to indicates we have fingers but have not 
%   adjusted IKs for it.
% 
% Inputs:
