function [mat_joint_traj,robot_joint_names, error_mesg] = convertPoseTraj2JointTraj(robot,mat_traj,toolFlag)
%   convertPoseTraj2JointTraj - Compute IKs for Cartesian trajectory. 
%   Will need to:
%       1. Create an array of joint angles the same size as trajectory
%       2. Instantiate a UR5 object
%       3. Perform adjustments for URDF Fwd Kins1
